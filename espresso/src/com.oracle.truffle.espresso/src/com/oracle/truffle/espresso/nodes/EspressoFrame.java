...
public final class EspressoFrame {
    ...
    /*  puts a reified long in ONE slot
        it expects an object, so it should use one slot
        a normal long takes up two slots.
    */
    public static void putReifiedLong(Frame frame, int slot, long value){
        assert slot >= 0;
    ...
    /*  puts a reified double in ONE slot
        since it expects an object, it should use one slot
        and a normal double takes up two slots.
    */
    public static void putReifiedDouble(Frame frame, int slot, double value) {
        assert slot >= 0;
